...
import ar.edu.unju.fi.ejercicio2.model.Efemerides;

public class Main {

	public static void main(String[] args) {
		Scanner scanner=new Scanner(System.in);
		List<Efemerides> lista = new ArrayList<>();
		boolean band;
		int op;
		do {
			System.out.println("\n--MENU--");
            ...
            switch (op) {
                case 1:
                    ...
                    Efemerides efemeride = new Efemerides(codigo, mes, dia, detalle);
                    lista.add(efemeride);
	...
	public static void modificar(Efemerides ef) {
